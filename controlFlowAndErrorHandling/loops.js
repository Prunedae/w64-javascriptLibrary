...
//! CHALLENGE:
//* Using a for loop, set an index to 2. Make a condition where if that number is greater than -10, change that index by subtracting
...
let word = 'supercalifragillisticexpialidocious';
...
for(char in name) {
    ...
    /*
        1) We are taking the value of the "n" index and declearing the position of 0
